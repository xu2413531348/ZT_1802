...
public class Elample20 {
	...
	public static void main(String[] args) throws ParseException {
		...
		SimpleDateFormat sdf=new SimpleDateFormat("Gyyyy年MM月dd日 HH:ss E");
		...
		//用sdf1对象来解析当前日期加100天
		//simpleDateFormat：parse方法将字符串解析为Date类对象
		//simpleDateFormat：format方法将Date类对象格式化为字符串
